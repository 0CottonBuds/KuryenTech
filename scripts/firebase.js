...
async function addAppliance(username, appliance_name, KW_HR, HR_per_day, days_per_week){
  const userDocRef = doc(db, "users", username);

  const applianceDocRef = doc(collection(userDocRef, "appliances"), appliance_name)
...
export {registerUser, addAppliance, addBill, test_firebase_add, AuthUser, getAppliancesOfUser, getBillsOfUser, changeLocation, changeName, changeTargetCost}
